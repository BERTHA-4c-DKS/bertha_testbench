...
grep "total analytical fitted density" run_"$numth"_"$BERTHA_KRGRID"_"$BERTHA_KAGRID".out  | tail -n 
grep "convergence obtained in" run_"$numth"_"$BERTHA_KRGRID"_"$BERTHA_KAGRID".out .out  | tail -n 
